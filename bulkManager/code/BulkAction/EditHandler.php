...
class EditHandler extends Handler
{
    ...
    public function index()
    {
        ...
        Requirements::javascript('colymba/gridfield-bulk-editing-tools: client/dist/bulk-manager/javascript/GridFieldBulkEditingForm.js');
        Requirements::css('colymba/gridfield-bulk-editing-tools: client/dist/bulk-manager/css/GridFieldBulkEditingForm.css');
        Requirements::add_i18n_javascript('colymba/gridfield-bulk-editing-tools: client/dist/lang/js');
